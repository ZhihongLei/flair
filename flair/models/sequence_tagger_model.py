...
class SequenceTagger(flair.nn.Model):
    ...
    def load_from_file(cls, model_file: Union[str, Path]):
        ...
        model = SequenceTagger(
            ...
            additional_tag_embeddings=state['additional_tag_embeddings'] if 'additional_tag_embeddings' in state else None,
            additional_tag_dictionaries=state['additional_tag_dictionaries'] if 'additional_tag_dictionaries' in state else None,
