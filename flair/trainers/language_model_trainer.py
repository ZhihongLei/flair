...
class TextCorpus(object):
    ...
    def __init__(self,
        ...
        self.train = TextDataset(path / 'train.txt', dictionary, True, self.forward, self.split_on_char,
        ...
        self.valid = \
            TextDataset(path / 'valid.txt', dictionary, True, self.forward, self.split_on_char, self.random_case_flip,
                        shuffle_lines=False)[0]
        self.test = \
            TextDataset(path / 'test.txt', dictionary, True, self.forward, self.split_on_char, self.random_case_flip,
                        shuffle_lines=False)[0]
...
class MyLMTrainer:
    ...
    def train(self,
        ...
        try:
            ...
            for epoch in range(0 + self.epoch, max_epochs + self.epoch):
                ...
                for batch_no, batch in enumerate(batches):
                    loss, num_words = self.model.forward(batch)
        ...
        _, final_ppl = self.evaluate(self.model, self.corpus.test, eval_mini_batch_size)
    ...
    def evaluate(model,
        ...
        with torch.no_grad():
            ...
            for batch in batches:
                loss, num_words = model.forward(batch)
